...
!function(e, t) {
    ...
    class r extends t {
        ...
        fitToData(e) {
            if (!this.isGroup) {
                ...
                t)) {
                    var i = t + 1;
                    e ? this.setWidth(i) : (this.maxInitialWidth && !e && (i = Math.min(i, this.maxInitialWidth)),
                ...
                if (a && a.target === n)
                    ...
                    case "group":
                        if (s.components.includes("row") || s.components.includes("cell") || s.components.includes("group")) {
                            i = this.table.rowManager.getVisibleRows(!0).find((e => e.getElement() === n)),
    ...
    class T extends t {
        ...
        lookupProp(e, t, i) {
            var s;
            return this.props[e] && this.props[e][t] ? this.props[e][t] : (s = this.lookupKey(e, i)) ? (this.props[e] || (this.props[e] = {}),
            this.props[e][t] = s[t] || s,
            this.props[e][t]) : void 0
        }
        lookupKey(e, t) {
            var i;
            return this.deps[e] ? i = this.deps[e] : window[e] ? (this.deps[e] = window[e],
            i = this.deps[e]) : t || this.error(e),
            i
        }
        error(e) {
    ...
    let k = class e extends t {
        ...
        _fitToScreen(e, t, i, s, o) {
            ...
            (e + this.element.offsetWidth >= this.container.offsetWidth || this.reversedX) && (this.element.style.left = "",
    ...
    class D extends M {
        ...
        initialize() {
            ...
            D.modes[e] ? this.mode = e : (console.warn("Layout Error - invalid mode set, defaulting to 'fitData' : " + e),
            this.mode = "fitData"),
        ...
        layout(e) {
            ...
            D.modes[this.mode].call(this, this.table.columnManager.columnsByIndex, e),
    ...
    class _ extends H {
        ...
        static initializeModuleBinder(e) {
            _.modulesRegistered || (_.modulesRegistered = !0,
        ...
        static _registerModule(e) {
            Array.isArray(e) || (e = [e]),
            e.forEach((e => {
                _._registerModuleBinding(e),
                _._registerModuleExtensions(e)
            }
            ))
        }
    ...
    class A extends _ {
        ...
        static extendModule() {
            A.initializeModuleBinder(),
            A._extendModule(...arguments)
        }
    ...
    class ee extends M {
        ...
        generateRow(e, t) {
            ...
            i.component = !1,
            i.getComponent = () => (i.component || (i.component = new Q(i)),
            i.component),
            i.generateCells = () => {
                var t = [];
    ...
    var te = {
        ...
        pdf: function(e, t={}, i) {
            var s, o, n = [], r = [], a = {}, l = t.rowGroupStyles || {
                fontStyle: "bold",
                fontSize: 12,
                cellPadding: 6,
                fillColor: 220
            ...
            i.sheetOnly)
                ...
                if (i.sheets)
                    for (var c in i.sheets)
                        !0 === i.sheets[c] ? (r.SheetNames.push(c),
                        r.Sheets[c] = d()) : (r.SheetNames.push(c),
    ...
    class ie extends M {
        ...
        download(e, t, i, s, o) {
            var n = !1;
            if ("function" == typeof e ? n = e : ie.downloaders[e] ? n = ie.downloaders[e] : console.warn("Download Error - No such download type found: ", e),
            n) {
    ...
    let oe = class {
        ...
        _createInputElement() {
            ...
            return this.params.mask && se(t, this.params),
    ...
    var ne = {
        ...
        datetime: function(e, t, i, s, o) {
            var n, r = o.format, a = o.verticalNavigation || "editor", l = r ? this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime") : null, h = e.getValue(), d = document.createElement("input");
                ...
                success: function(t) {
                    ...
                    if (void 0 === e.modules.filter.prevSuccess || e.modules.filter.prevSuccess !== t) {
                        ...
                        e.modules.filter.emptyFunc(t))
                            ...
                            case "string":
                                me.filters[e.definition.headerFilterFunc] ? (r = e.definition.headerFilterFunc,
                                o = function(i) {
    ...
    var pe = {
        ...
        datetime: function(e, t, i) {
            var s, o = this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime"), n = t.inputFormat || "yyyy-MM-dd HH:mm:ss", r = t.outputFormat || "dd/MM/yyyy HH:mm:ss", a = void 0 !== t.invalidPlaceholder ? t.invalidPlaceholder : "", l = e.getValue();
            if (void 0 !== o)
        ...
        datetimediff: function(e, t, i) {
            var s, o = this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime"), n = t.inputFormat || "yyyy-MM-dd HH:mm:ss", r = void 0 !== t.invalidPlaceholder ? t.invalidPlaceholder : "", a = void 0 !== t.suffix && t.suffix, l = void 0 !== t.unit ? t.unit : "days", h = void 0 !== t.humanize && t.humanize, d = void 0 !== t.date ? t.date : o.now(), c = e.getValue();
            if (void 0 !== o)
        ...
        json: function(e, t, i) {
            var s = t.indent || "\t"
              ...
              , n = t.replacer || null
              , r = e.getValue();
            return o && (e.getElement().style.whiteSpace = "pre-wrap"),
    ...
    class ge extends M {
        ...
        lookupTypeFormatter(e, t) {
            ...
            return i.formatter = this.lookupFormatter(s),
            i
        }
        lookupFormatter(e) {
            var t;
            switch (typeof e) {
            case "string":
                ge.formatters[e] ? t = ge.formatters[e] : (console.warn("Formatter Error - No such formatter found: ", e),
        ...
        formatHeader(e, t, i) {
            var s, o, n, r;
            return e.definition.titleFormatter ? (s = this.lookupFormatter(e.definition.titleFormatter),
            n = t => {
    ...
    class Ee extends M {
        ...
        undo() {
            if (this.index > -1) {
                ...
                return Ee.undoers[e.type].call(this, e),
                this.index--,
        ...
        redo() {
            if (this.history.length - 1 > this.index) {
                this.index++;
                let e = this.history[this.index];
                return Ee.redoers[e.type].call(this, e),
    ...
    class Re extends M {
        ...
        lookupImporter(e) {
            ...
            (t = "string" == typeof e ? Re.importers[e] : e) || console.error("Import Error - Importer not found:", e),
            t
        }
        importFromFile(e, t, i) {
            var s = this.lookupImporter(e);
            if (s)
                return this.pickFile(t, i).then(this.importData.bind(this, s)).then(this.structureData.bind(this)).then(this.mutateData.bind(this)).then(this.validateData.bind(this)).then(this.setData.bind(this)).catch((e => (this.dispatch("import-error", e),
        ...
        importData(e, t) {
            var i;
            return this.table.dataLoader.alertLoader(),
            new Promise(( (s, o) => {
                setTimeout(( () => {
        ...
        structureArrayToColumns(e) {
            ...
            return s[0] && i[0] && s[0].getDefinition().title === i[0] && e.shift(),
            e.forEach((e => {
                var i = {};
    ...
    class ke extends M {
        ...
        initialize() {
            ...
            this.watchKeys = {},
            this.pressedKeys = [],
            !1 !== e && (Object.assign(t, ke.bindings),
            Object.assign(t, e),
            this.mapBindings(t),
            this.bindEvents()),
        ...
        mapBindings(e) {
            for (let t in e)
                ke.actions[t] ? e[t] && ("object" != typeof e[t] && (e[t] = [e[t]]),
                e[t].forEach((e => {
    ...
    class Fe extends M {
        ...
        initializePageCounter() {
            var e = this.table.options.paginationCounter
              , t = null;
            e && ((t = "function" == typeof e ? e : Fe.pageCounters[e]) ? (this.pageCounter = t,
        ...
        _parseRemoteData(e) {
            ...
            e.data) {
                ...
                if (this.page > this.max && (console.warn("Remote Pagination Error - Server returned last page value lower than the current page"),
                i = this.options("paginationOutOfRange")))
                    return this.setPage("function" == typeof i ? i.call(this, this.page, this.max) : i);
                this.dispatchExternal("pageLoaded", this.getPage())
            } else
    ...
    class Oe extends M {
        ...
        initialize() {
            if (this.table.options.persistence) {
                ...
                this.table.options.persistenceReaderFunc ? "function" == typeof this.table.options.persistenceReaderFunc ? this.readFunc = this.table.options.persistenceReaderFunc : Oe.readers[this.table.options.persistenceReaderFunc] ? this.readFunc = Oe.readers[this.table.options.persistenceReaderFunc] : console.warn("Persistence Read Error - invalid reader set", this.table.options.persistenceReaderFunc) : Oe.readers[this.mode] ? this.readFunc = Oe.readers[this.mode] : console.warn("Persistence Read Error - invalid reader set", this.mode),
                this.table.options.persistenceWriterFunc ? "function" == typeof this.table.options.persistenceWriterFunc ? this.writeFunc = this.table.options.persistenceWriterFunc : Oe.writers[this.table.options.persistenceWriterFunc] ? this.writeFunc = Oe.writers[this.table.options.persistenceWriterFunc] : console.warn("Persistence Write Error - invalid reader set", this.table.options.persistenceWriterFunc) : Oe.writers[this.mode] ? this.writeFunc = Oe.writers[this.mode] : console.warn("Persistence Write Error - invalid writer set", this.mode),
    ...
    class Ie extends t {
        ...
        getComponent() {
            return this.component || (this.component = new Ve(this)),
            this.component
        }
        destroy(e) {
            this.destroyed = !0,
    ...
    var je = {
        ...
        array: function(e, t, i, s, o, n, r) {
            ...
            Array.isArray(e)) {
                if (Array.isArray(t))
                    return "string" === h ? String(m(e)).toLowerCase().localeCompare(String(m(t)).toLowerCase()) : m(t) - m(e);
                c = 1
            } else
                c = Array.isArray(t) ? -1 : 0;
            return ("top" === d && "desc" === n || "bottom" === d && "asc" === n) && (c *= -1),
            c
        },
    ...
    var Ye = Object.freeze({
        ...
        GroupRowsModule: class extends M {
            ...
            createGroup(e, t, i) {
                var s, o = t + "_" + e;
                i = i || [],
                s = new fe(this,!1,t,e,this.groupIDLookups[0].field,this.headerGenerator[0],i[o]),
                this.groups[o] = s,
                this.groupList.push(s)
            }
        ...
        SelectRangeModule: class extends M {
            ...
            navigate(e, t, i) {
                ...
                return this.rowHeader && 0 === a && (a = 1),
                t || s.setStart(r, a),
                s.setEnd(r, a),
                t || (this.selecting = "cell"),
                n.top !== s.top || n.bottom !== s.bottom || n.left !== s.left || n.right !== s.right ? (l = this.getRowByRangePos(s.end.row),
            ...
            autoScroll(e, t, i) {
                ...
                }).top < s.top && s.top < o.bottom && o.top < s.bottom && s.bottom < o.bottom,
            ...
            resetRanges() {
                ...
                this.options("selectableRangeAutoFocus") && this.initializeFocus(t))),
                e
            }
            tableDestroyed() {
                document.removeEventListener("mouseup", this.mouseUpEvent),
