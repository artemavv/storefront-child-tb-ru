                ...
                <?php foreach ($attributes as $attribute_name => $options) : ?>
                    <tr>
                        <th class="label"><label
                                    for="<?php echo esc_attr(sanitize_title($attribute_name)); ?>"><?php echo wc_attribute_label(__($attribute_name, 'tannybunny') ); // WPCS: XSS ok. ?></label>
                        </th>
                        <td class="value">
                            <?php
                            ...
                            wc_dropdown_variation_attribute_options(
                                array(
                                    ...
                                    'product' => $product,
                                    'show_option_none' => __('Select an option', 'tannybunny')
                                )
                            );
